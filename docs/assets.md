...
## Exploration illustration atlases and readable diagrams (031 / 035)

- Runtime atlases live in `public/images/items/exploration-art/`, with original generated PNGs in its `source/` directory. Eleven square atlases provide 44 named frames, now all referenced by 37 activities. Feature 035 connected the two previously unused planting-preparation frames and separated the planting-procedure artwork from the received-seeds story.
