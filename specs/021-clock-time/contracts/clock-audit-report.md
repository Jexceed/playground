...
- A clock reading round's instruction, feedback, retry, parent prompt, or
  difficulty note does not name `时针/短针` before `分针/长针`.
- The rendered clock hint or accessible description presents the minute hand
